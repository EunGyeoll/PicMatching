...
export default async function BookingCompletePage({
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-120 flex-col pb-6">
      ...
      <div className="mx-4 flex flex-col gap-2 rounded-xl border border-stone-200 p-4 text-sm">
      ...
      <div className="flex flex-col gap-1.5 px-6 py-5">
        <h2 className="text-sm font-bold text-stone-400">준비 사항</h2>
      ...
      <div className="mt-auto flex gap-2 px-4 pt-4">
        <Link
          href="/"
          className="flex-1 rounded-lg border border-stone-300 py-3 text-center text-base font-semibold text-stone-700"
        >
          홈으로
        </Link>
        <Link
          href="/bookings"
          className="flex-1 rounded-lg bg-stone-900 py-3 text-center text-base font-bold text-white"
        >
          내 예약 보기
        </Link>
      </div>
